...
{
	public const MODEL_ALIAS = 'Locality';

	public const TABLE_NAME = 'Localities';

	public const ENTITY_CLASS = 'App\Domain\Common\Entities\PoliticalEntities\Localities\Locality';
